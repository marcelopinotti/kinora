...
export function Gerenciar() {
  return (
    <div className="relative min-h-screen pb-[70px]">
      <TopBar />
      <div className="px-pad mx-auto flex w-full max-w-[calc(1180px+var(--spacing-pad)*2)] flex-col gap-[26px] pt-[18px]">
        <div>
          <p className="eyebrow">Gerenciar</p>
          <h1 className="text-[clamp(26px,5vw,34px)] font-extrabold tracking-[-0.02em]">Categorias e streamings</h1>
          <p className="text-t3 mt-2 max-w-[620px] text-[15px] [text-wrap:pretty]">
            São as listas usadas no cadastro de filmes. Qualquer pessoa logada pode criar, renomear e excluir.
          </p>
        </div>
