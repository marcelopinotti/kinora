        ...
        <div className="relative min-h-screen pb-[70px]">
            ...
            aspas: a URL vem do usuário e não pode fechar o url(") e emendar CSS. */}
                ...
                <div
                    ...
                    {filme.posterUrl ? (
                        <div
                            className="border-border-2 bg-surface-2 shadow-card aspect-[2/3] overflow-hidden rounded-xl border max-[860px]:w-[min(210px,55%)]">
                            <img className="block size-full object-cover" src={filme.posterUrl}
                                 alt={`Pôster de ${filme.titulo}`}/>
                        </div>
                    ) : (
                        // sem pôster não há .detalhe-bg: a moldura sozinha segura a composição
                        <div
                            className="art-empty border-border-2 shadow-card flex aspect-[2/3] items-center justify-center overflow-hidden rounded-xl border max-[860px]:w-[min(210px,55%)]">
              ...
              <span
                  className="bg-accent-soft border-accent-line rounded-full border px-3 py-[5px] text-[15px] font-extrabold text-white">
